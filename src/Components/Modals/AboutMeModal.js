        ...
        >
          ...
          <div className="modal-job-details">
            ...
            <ul>
              ...
              <li><span style={{fontWeight: "bold"}}>Googling:</span> This mightn't seem to be a strong skill, but in my opinion it is. All information is available on the internet. So, arguably, it's more important to be able to gather this information when necessary than it is to know everything by heart. Luckily for me, my experience as a Google Ads Specialist has helped me to understand how Google's algorithms give results so that I can use the engine very efficiently.</li>
              <li><span style={{fontWeight: "bold"}}>Communication:</span> I have been told my communication skills are at a high level. Weird to write stuff like this about myself, but I agree. I'm able to clearly state what needs to be communicated and I am not afraid to open my mouth or to pick up the phone. </li>
